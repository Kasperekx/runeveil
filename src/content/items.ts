...
import itemsYaml from "@mmo/shared/data/items.yaml?raw";
...
/** Must match server/src/sim/durabilityConfig.ts; server validates every charge. */
...
function parseUseEffect(entry: ItemYamlEntry["use"]): ItemUseEffect | null {
