/**
 * Shared melee combat constants (keep in sync with server/src/world/combatConfig.ts).
 */
export const ATTACK_RANGE = 56;
/** Base time between accepted melee hits (Tibia-ish pace). */
export const ATTACK_COOLDOWN_MS = 1000;
export const TAB_RANGE = 560;
/** Click must land within this of an animal center. */
export const ATTACK_CLICK_RADIUS = 40;
